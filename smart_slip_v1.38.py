...
# MANUAL LOG (simplified - no vehicle name, no actual ET)
with tab_manual:
...
# PREDICT + GROK (removed manual prediction, kept only Grok)
with tab_predict:
...
st.divider()
st.caption("Smart Slip v1.38 • Built for bracket racers")