...
# ============== UI ==============
st.title("🏁 Smart Slip")
st.caption("v1.33 • Per-Vehicle Predictions + Notes Focused")
...
# PREDICT + GROK (Vehicle-specific, no dial-in recommendation)
with tab_predict:
    ...
    st.divider()
    st.subheader("Ask Grok (Full Context + Notes)")
...
with tab_settings:
    ...
    st.caption("v1.33 • Per-Vehicle Predictions")

st.divider()
st.caption("Smart Slip v1.33 • Built for bracket racers")